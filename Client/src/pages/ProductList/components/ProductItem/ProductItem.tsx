  ...
  return (
    ...
    >
      ...
      <div className='p-3 text-xs'>
        ...
        <ul className='mb-[10px] mt-3 list-inside list-circle overflow-hidden pl-1 leading-[18px] xl:h-[108px] 2xl:h-[204px] 2xl:text-sm'>
        ...
        {showrooms.length > 0 ? (
          ...
          <div className='mt-5 flex items-center gap-1 text-[#0074da]'>
