    ...
    <div className='flex h-screen w-screen items-center bg-gray-50'>
      <div className='container flex flex-col items-center justify-between px-5 text-gray-700 md:flex-row'>
        <div className='mx-8 w-full lg:w-1/2'>
          <div className='font-dark mb-8 text-7xl font-extrabold text-green-500'> 404</div>
          <p className='mb-8 text-2xl font-light leading-normal md:text-3xl'>
            Sorry we could not find the page you are looking for
          </p>
          <Link
            to={'/'}
            className='duration-400 inline rounded-lg border border-transparent bg-green-600 px-5 
            py-3 text-sm font-medium leading-5 text-white shadow-2xl transition-all hover:bg-red-700 focus:outline-none active:bg-red-600'
          >
            back to homepage
          </Link>
        </div>
