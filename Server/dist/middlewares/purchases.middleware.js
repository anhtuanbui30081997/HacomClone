...
exports.addToCartValidator = (0, validation_1.validate)((0, express_validator_1.checkSchema)({
    product_id: {
        isString: {
            errorMessage: messages_1.PURCHASE_MESSAGES.PRODUCT_ID_MUST_BE_A_STRING
        },
        custom: {
            options: async (value, { req }) => {
                try {
                    ...
                    if (product === null) {
                        throw new Error(messages_1.PURCHASE_MESSAGES.PRODUCT_NOT_EXISTED);
                    }
                    return true;
                }
                catch (error) {
    ...
    buy_count: {
        isNumeric: {
            errorMessage: messages_1.PURCHASE_MESSAGES.BUY_COUNT_MUST_BE_A_NUMBER
        }
    }
}, ['body']));
